...
import { pgTable as pgTableCore, varchar, boolean, integer, text, index } from "drizzle-orm/pg-core";
...
// 用户表
export const users = pgTableCore(
  "users",
  {
...
// 免费码表
export const freeCodes = pgTableCore(
  "free_codes",
  {
    id: varchar("id", { length: 36 }).primaryKey().default(sql`gen_random_uuid()`),
...
// 验证码表
export const verificationCodes = pgTableCore(
  "verification_codes",
  {
    id: varchar("id", { length: 36 }).primaryKey().default(sql`gen_random_uuid()`),
...
// 用户会员有效期表
export const userMemberships = pgTableCore(
  "user_memberships",
  {
    id: varchar("id", { length: 36 }).primaryKey().default(sql`gen_random_uuid()`),
