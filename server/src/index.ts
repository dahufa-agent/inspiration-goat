...
// 免费通道文案模型：DeepSeek-V3（成本低，适合免费用户）
const FREE_TEXT_MODEL = "deepseek-v3";  // 免费用户文案模型
// 付费通道文案模型：DeepSeek-V4（高性能，适合付费用户）
const TEXT_MODEL = "deepseek-v4-32-250326";  // 付费用户文案模型
