...
import { ImageGenerationClient, VideoGenerationClient, LLMClient, FetchClient, Config, HeaderUtils, } from "coze-coding-dev-sdk";
// AI 模型配置
...
请直接输出文案内容，不需要解释。`;
        ...
        let messages = [
            ...
            { role: "user", content: `想法主题：${currentPrompt}\n\n请生成一段吸引人的文案，可以用于配图或视频旁白。` },
        ];
