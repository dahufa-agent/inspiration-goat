...
const Header = () => {
    ...
    return (<header className="bg-white shadow-sm border-b border-gray-100">
        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center space-x-4">
            {user ? (<>
                ...
                <Link to="/register" className="bg-indigo-600 text-white px-4 py-2 rounded-lg text-sm hover:bg-indigo-700 transition-colors">
                  注册
                </Link>
              </>)}
          </div>
