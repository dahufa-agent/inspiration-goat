 ...
 */
function getDefaultEnteringAnimation(placement, offset) {
 ...
 */
function getDefaultExitingAnimation(placement, offset) {
    const translateDistance = Math.min(offset, 12);
    switch (placement) {
        case 'top':
 ...
 */
export function usePopupPopoverContentAnimation({ placement, offset, animation, }) {
