...
export const AnimatedCheckIcon = ({ isSelected = false, size = DEFAULT_SIZE, strokeWidth = 2.5, color, enterDuration = ENTER_DURATION, exitDuration = EXIT_DURATION, }) => {
    ...
    return (<Svg width={size} height={size} viewBox={`0 0 ${DEFAULT_SIZE} ${DEFAULT_SIZE}`} fill="none">
      <AnimatedPath d="M4 9.5L8 13L14 6" stroke={color ?? themeColorForeground} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" animatedProps={animatedCheckProps}/>
    </Svg>);
};
