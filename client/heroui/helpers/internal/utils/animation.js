 ...
 */
export function shouldDisableAll(animation) {
 ...
 */
export function getAnimationState(animation) {
    ...
    const config = typeof animation === 'object' && animation !== null
        ? animation
        : undefined;
    return {
 ...
 */
export function getRootAnimationState(animation) {
 ...
 * });
 */
export function getAnimationValueProperty(options) {
 ...
 * });
 */
export function getAnimationValueMergedConfig(options) {
    // If animation value is undefined, return default
    if (options.animationValue === undefined) {
        return options.defaultValue;
    }
...
export function getCombinedAnimationDisabledState(options) {
    const { globalIsAllAnimationsDisabled, parentIsAllAnimationsDisabled, ownIsAllAnimationsDisabled, } = options;
