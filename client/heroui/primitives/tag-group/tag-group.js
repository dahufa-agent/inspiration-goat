...
// Root
// --------------------------------------------------
const Root = forwardRef(({ asChild, selectionMode = 'none', selectedKeys: selectedKeysProp, defaultSelectedKeys, onSelectionChange: onSelectionChangeProp, disabledKeys: disabledKeysProp, isDisabled = false, isInvalid = false, isRequired = false, onRemove, ...viewProps }, ref) => {
...
// Item
// --------------------------------------------------
const Item = forwardRef(({ asChild, id: itemId, isDisabled: isDisabledProp = false, onPress: onPressProp, ...props }, ref) => {
    const { selectionMode, selectedKeys, onSelectionChange, disabledKeys, isDisabled: isGroupDisabled, onRemove, } = useRootContext();
    ...
    return (<ItemContext.Provider value={itemContextValue}>
        <Component ref={ref} role="listitem" aria-selected={isSelected} disabled={effectiveDisabled} accessibilityState={{
            selected: isSelected,
...
// ItemLabel
// --------------------------------------------------
const ItemLabel = forwardRef(({ asChild, ...props }, ref) => {
...
// RemoveButton
// --------------------------------------------------
const RemoveButton = forwardRef(({ asChild, onPress: onPressProp, ...props }, ref) => {
    ...
    const Component = asChild ? Slot.Pressable : Pressable;
    return (<Component ref={ref} role="button" aria-label="Remove" disabled={isDisabled} onPress={onPress} {...props}/>);
});
