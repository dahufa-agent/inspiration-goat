...
function Root({ asChild, ref, value: valueProp, defaultValue, onValueChange: onValueChangeProp, isOpen: isOpenProp, isDefaultOpen, onOpenChange: onOpenChangeProp, isDisabled, selectionMode = 'single', presentation = 'popover', ...viewProps }) {
...
// --------------------------------------------------
const Trigger = forwardRef(({ asChild, onPress: onPressProp, onLayout: onLayoutProp, isDisabled = false, ...props }, ref) => {
    ...
    return (<Component ref={augmentedRef} aria-disabled={isDisabledValue} role="combobox" onPress={onPress} disabled={isDisabledValue} onLayout={onLayout} {...props}/>);
});
// --------------------------------------------------
...
// --------------------------------------------------
const TriggerIndicator = forwardRef(({ asChild, ...props }, ref) => {
    const Component = asChild ? Slot.View : View;
...
function Portal({ forceMount, hostName, children }) {
    ...
    return (<PrimitivePortal hostName={hostName} name={`${value.nativeID}_portal`}>
 ...
 */
const PopoverContent = forwardRef(({ asChild = false, forceMount, align = 'start', placement = 'bottom', offset = 0, alignOffset = 0, avoidCollisions = true, onLayout: onLayoutProp, insets, style, disablePositioningStyle, width = 'content-fit', ...props }, ref) => {
    ...
    const Component = asChild ? Slot.View : View;
    return (<Component ref={ref} role="dialog" nativeID={nativeID} aria-modal={true} style={flatStyle} onLayout={onLayout} {...props}/>);
});
// --------------------------------------------------
const DialogContent = forwardRef(({ asChild, forceMount, ...props }, ref) => {
...
// --------------------------------------------------
const Item = React.forwardRef(({ asChild, value: itemValue, label, onPress: onPressProp, disabled = false, closeOnPress: closeOnPressProp, ...props }, ref) => {
    const { onOpenChange, value, onValueChange, selectionMode, setTriggerPosition, setContentLayout, } = useRootContext();
    ...
    const Component = asChild ? Slot.Pressable : Pressable;
    return (<ItemContext.Provider value={{ itemValue, label }}>
        <Component ref={ref} role="option" onPress={onPress} disabled={disabled} aria-checked={checked} aria-valuetext={label} aria-disabled={!!disabled} accessibilityState={{
            disabled: !!disabled,
            checked,
        }} {...props}/>
...
// --------------------------------------------------
const ItemLabel = React.forwardRef(({ asChild, ...props }, ref) => {
...
// --------------------------------------------------
const GroupLabel = React.forwardRef(({ asChild, ...props }, ref) => {
    const Component = asChild ? Slot.Text : Text;
    return <Component ref={ref} {...props}/>;
});
// --------------------------------------------------
