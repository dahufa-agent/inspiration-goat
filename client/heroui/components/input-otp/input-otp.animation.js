...
import { Easing, FadeIn, FadeOut, FlipInXDown, FlipOutXDown, useAnimatedStyle, useSharedValue, withRepeat, withSequence, withTiming, } from 'react-native-reanimated';
import { useAnimationSettings } from '../../helpers/internal/contexts';
import { useCombinedAnimationDisabledState } from '../../helpers/internal/hooks';
import { getAnimationState, getAnimationValueProperty, getIsAnimationDisabledValue, } from '../../helpers/internal/utils';
/**
...
export function useInputOTPSlotCaretAnimation(options) {
    ...
    useEffect(() => {
        ...
        opacity.set(withRepeat(withSequence(withTiming(opacityValue[0], { duration: opacityDuration }), withTiming(opacityValue[1], { duration: opacityDuration })), -1, true));
        height.set(withRepeat(withSequence(withTiming(heightValue[0], { duration: heightDuration }), withTiming(heightValue[1], { duration: heightDuration })), -1, true));
    }, [
