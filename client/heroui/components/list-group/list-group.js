...
// --------------------------------------------------
const ListGroupRoot = forwardRef((props, ref) => {
    const { children, variant = 'default', className, style, ...restProps } = props;
    const rootClassName = listGroupClassNames.root({ className });
    return (<Surface ref={ref} variant={variant} className={rootClassName} style={[styleSheet.root, style]} {...restProps}>
      {children}
    </Surface>);
});
// --------------------------------------------------
const ListGroupItem = forwardRef((props, ref) => {
    ...
    return (<Pressable ref={ref} className={itemClassName} {...restProps}>
        {children}
      </Pressable>);
});
// --------------------------------------------------
const ListGroupItemPrefix = forwardRef((props, ref) => {
    const { children, ...restProps } = props;
    return (<View ref={ref} {...restProps}>
        {children}
      </View>);
});
// --------------------------------------------------
const ListGroupItemContent = forwardRef((props, ref) => {
    const { children, className, style, ...restProps } = props;
    const contentClassName = listGroupClassNames.itemContent({ className });
    return (<View ref={ref} className={contentClassName} style={style} {...restProps}>
        {children}
      </View>);
});
// --------------------------------------------------
const ListGroupItemTitle = forwardRef((props, ref) => {
    const { children, className, ...restProps } = props;
...
// --------------------------------------------------
const ListGroupItemDescription = forwardRef((props, ref) => {
    const { children, className, ...restProps } = props;
...
// --------------------------------------------------
const ListGroupItemSuffix = forwardRef((props, ref) => {
    ...
    return (<View ref={ref} {...restProps}>
        {children ?? (<ChevronRightIcon size={resolvedIconProps.size} color={resolvedIconProps.color}/>)}
      </View>);
});
// --------------------------------------------------
