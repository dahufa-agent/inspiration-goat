...
const Label = forwardRef((props, ref) => {
    const { children, isDisabled: localIsDisabled, isRequired: localIsRequired, isInvalid: localIsInvalid, className, animation, ...restProps } = props;
    ...
    const isRequired = localIsRequired !== undefined
        ? localIsRequired
    ...
    return (<AnimationSettingsProvider value={animationSettingsContextValue}>
      <LabelProvider value={contextValue}>
        <LabelPrimitives.Root ref={ref} isDisabled={isDisabled} className={rootClassName} {...restProps}>
...
const LabelText = forwardRef((props, ref) => {
    ...
    return (<HeroText ref={ref} className={textClassName} style={[style, styles?.text]} {...restProps}>
      {children}
      {isRequired && (<HeroText className={asteriskClassName} style={styles?.asterisk}>
          {' '}
          *
        </HeroText>)}
    </HeroText>);
