...
const AlertRoot = forwardRef((props, ref) => {
    ...
    return (<AlertPrimitives.Root ref={ref} status={status} className={rootClassName} style={[alertStyleSheet.root, style]} {...restProps}>
        {children}
      </AlertPrimitives.Root>);
});
// --------------------------------------------------
const AlertIndicator = forwardRef((props, ref) => {
    ...
    return (<AlertPrimitives.Indicator ref={ref} className={indicatorClassName} {...restProps}>
...
const AlertContent = forwardRef((props, ref) => {
    ...
    return (<AlertPrimitives.Content ref={ref} className={contentClassName} {...restProps}>
      {children}
...
const AlertTitle = forwardRef((props, ref) => {
    ...
    return (<AlertPrimitives.Title asChild {...restProps}>
...
const AlertDescription = forwardRef((props, ref) => {
    ...
    return (<AlertPrimitives.Description asChild {...restProps}>
