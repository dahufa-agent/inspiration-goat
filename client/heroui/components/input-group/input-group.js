...
// --------------------------------------------------
const InputGroupRoot = forwardRef((props, ref) => {
    ...
    const animationSettingsContextValue = useMemo(() => ({ isAllAnimationsDisabled }), [isAllAnimationsDisabled]);
    ...
    return (<InputGroupProvider value={inputGroupContextValue}>
...
// --------------------------------------------------
const InputGroupPrefix = forwardRef((props, ref) => {
    ...
    return (<View ref={ref} className={prefixClassName} onLayout={onLayout} pointerEvents={isDecorative || isDisabled ? 'none' : undefined} accessibilityElementsHidden={isDecorative || undefined} importantForAccessibility={isDecorative ? 'no-hide-descendants' : undefined} {...restProps}>
        {children}
      </View>);
});
// --------------------------------------------------
const InputGroupSuffix = forwardRef((props, ref) => {
    const { children, className, isDecorative = false, onLayout: onLayoutProp, ...restProps } = props;
    const context = useInputGroup();
    const formField = useFormField();
    const isDisabled = context?.isDisabled ?? formField?.isDisabled ?? false;
    ...
    return (<View ref={ref} className={suffixClassName} onLayout={onLayout} pointerEvents={isDecorative || isDisabled ? 'none' : undefined} accessibilityElementsHidden={isDecorative || undefined} importantForAccessibility={isDecorative ? 'no-hide-descendants' : undefined} {...restProps}>
        {children}
      </View>);
});
// --------------------------------------------------
const InputGroupInput = forwardRef((props, ref) => {
    ...
    const autoPaddingStyle = useMemo(() => {
        const paddingLeft = context?.prefixWidth && context.prefixWidth > 0
            ? context.prefixWidth
            : undefined;
        const paddingRight = context?.suffixWidth && context.suffixWidth > 0
            ? context.suffixWidth
            : undefined;
    ...
    return (<Input ref={ref} style={[autoPaddingStyle, style]} isDisabled={isDisabled} {...restProps}/>);
});
// --------------------------------------------------
