...
export const ArrowSvg = ({ width, height, placement, fill, stroke, strokeWidth = 1, style, svgProps, }) => {
    const getPaths = () => {
    ...
    return (<Svg width={svgWidth} height={svgHeight} viewBox={viewBox} style={style} {...svgProps}>
      <Path d={fillPath} fill={fill} stroke="none"/>
      <Path d={strokePath} fill="none" stroke={stroke} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round"/>
    </Svg>);
};
