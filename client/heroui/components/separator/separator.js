...
// --------------------------------------------------
const SeparatorRoot = forwardRef((props, ref) => {
    const { variant = 'thin', orientation = 'horizontal', thickness, className, style, ...restProps } = props;
     ...
     */
    const customThicknessStyle = thickness !== undefined
        ? orientation === 'horizontal'
            ? { height: thickness }
            : { width: thickness }
        : undefined;
    return (<View ref={ref} className={rootClassName} style={customThicknessStyle ? [customThicknessStyle, style] : style} {...restProps}/>);
});
// --------------------------------------------------
