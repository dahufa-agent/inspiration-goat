...
const Surface = forwardRef(({ children, variant = 'default', className, style, animation, ...props }, ref) => {
    ...
    return (<AnimationSettingsProvider value={animationSettingsContextValue}>
        <SurfaceProvider value={contextValue}>
          <View ref={ref} className={rootClassName} style={[surfaceStyleSheet.root, style]} {...props}>
            {children}
          </View>
        </SurfaceProvider>
