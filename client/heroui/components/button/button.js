...
const ButtonRoot = forwardRef((props, ref) => {
    const { children, variant = 'primary', feedbackVariant = 'scale-highlight', animation, size = 'md', isIconOnly = false, isDisabled = false, className, style, accessibilityRole = 'button', ...restProps } = props;
    const [themeColorAccentHover, themeColorDefaultHover, themeColorDangerHover, themeColorDangerSoftHover,] = useThemeColor([
        'accent-hover',
        'default-hover',
        'danger-hover',
        'danger-soft-hover',
    ...
    return (<ButtonProvider value={contextValue}>
      <PressableFeedback ref={ref} isDisabled={isDisabled} className={rootClassName} style={typeof style === 'function'
            ? (state) => [buttonStyleSheet.buttonRoot, style(state)]
            : [buttonStyleSheet.buttonRoot, style]} accessibilityRole={accessibilityRole} accessibilityState={{ disabled: isDisabled }} animation={rootAnimation} {...restProps}>
        {feedbackVariant === 'scale-highlight' &&
            highlightAnimationConfig !== undefined && (<PressableFeedback.Highlight animation={highlightAnimationConfig}/>)}
        {feedbackVariant === 'scale-ripple' &&
            rippleAnimationConfig !== undefined && (<PressableFeedback.Ripple animation={rippleAnimationConfig}/>)}
        {content}
      </PressableFeedback>
    </ButtonProvider>);
});
// --------------------------------------------------
const ButtonLabel = forwardRef((props, ref) => {
