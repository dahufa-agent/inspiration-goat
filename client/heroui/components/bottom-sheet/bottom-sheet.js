...
import { FullWindowOverlay, HeroText, BottomSheetContent as InternalBottomSheetContent, } from '../../helpers/internal/components';
...
import { BottomSheetAnimationProvider, useBottomSheetAnimation, } from './bottom-sheet.animation';
import { DISPLAY_NAME } from './bottom-sheet.constants';
import { bottomSheetClassNames, bottomSheetStyleSheet, } from './bottom-sheet.styles';
...
// --------------------------------------------------
const BottomSheetRoot = forwardRef(({ children, isOpen, isDefaultOpen, onOpenChange, animation, ...props }, ref) => {
    ...
    return (<AnimationSettingsProvider value={animationSettingsContextValue}>
        <BottomSheetAnimationProvider value={animationContextValue}>
          <BottomSheetPrimitives.Root ref={ref} isOpen={isOpen} isDefaultOpen={isDefaultOpen} onOpenChange={onOpenChange} {...props}>
            {children}
...
// --------------------------------------------------
const BottomSheetPortal = ({ children, disableFullWindowOverlay = false, ...props }) => {
    const animationSettingsContext = useAnimationSettings();
    const animationContext = useBottomSheetAnimation();
    return (<BottomSheetPrimitives.Portal {...props}>
...
// --------------------------------------------------
const BottomSheetOverlay = forwardRef(({ className, style, animation, isAnimatedStyleActive = true, ...props }, ref) => {
    ...
    const overlayStyle = isAnimatedStyleActive
        ...
        : style;
    return (<AnimatedOverlay ref={ref} className={overlayClassName} style={overlayStyle} pointerEvents={isOpen ? 'auto' : 'none'} {...props}/>);
});
// --------------------------------------------------
const BottomSheetContent = forwardRef(({ children, index: initialIndex, backgroundClassName, handleIndicatorClassName, contentContainerClassName: contentContainerClassNameProp, contentContainerProps, animationConfigs, animation, ...restProps }, ref) => {
    const { isOpen, onOpenChange } = useBottomSheet();
    const { progress, isDragging } = useBottomSheetAnimation();
    return (<InternalBottomSheetContent ref={ref} index={initialIndex} backgroundClassName={backgroundClassName} handleIndicatorClassName={handleIndicatorClassName} contentContainerClassName={contentContainerClassNameProp} contentContainerProps={contentContainerProps} animation={animation} animationConfigs={animationConfigs} backgroundStyle={[
...
// --------------------------------------------------
const BottomSheetTitle = forwardRef(({ className, children, ...props }, ref) => {
...
// --------------------------------------------------
const BottomSheetDescription = forwardRef(({ className, children, ...props }, ref) => {
    const { nativeID } = useBottomSheet();
