...
import { useRadioIndicatorThumbAnimation, useRadioRootAnimation, } from './radio.animation';
 ...
 */
const RadioRoot = forwardRef((props, ref) => {
    const { children, isSelected: isSelectedProp, onSelectedChange: onSelectedChangeProp, isDisabled: isDisabledProp, isInvalid: isInvalidProp, variant: variantProp, className, animation, ...restProps } = props;
    ...
    const finalVariant = variantProp !== undefined
        ? variantProp
    ...
    return (<AnimationSettingsProvider value={animationSettingsContextValue}>
        <RadioPrimitives.Root ref={ref} variant={finalVariant} className={rootClassName} isSelected={isSelected} onSelectedChange={onSelectedChange} isDisabled={isDisabled} isInvalid={isInvalid} hitSlop={props.hitSlop ?? DEFAULT_HIT_SLOP} {...restProps}>
          {content}
...
const RadioIndicator = forwardRef((props, ref) => {
    ...
    return (<AnimatedRadioIndicator ref={ref} className={indicatorClassName} style={[radioStyleSheet.borderCurve, style]} {...restProps}>
        {children ?? <RadioIndicatorThumb />}
      </AnimatedRadioIndicator>);
});
// --------------------------------------------------
const RadioIndicatorThumb = forwardRef((props, ref) => {
