...
const RadioGroupRoot = forwardRef((props, ref) => {
    ...
    return (<AnimationSettingsProvider value={animationSettingsContextValue}>
      <FormFieldProvider value={formFieldContextValue}>
        <RadioGroupPrimitives.Root ref={ref} className={rootClassName} isDisabled={isDisabled} isInvalid={isInvalid} {...restProps}/>
      </FormFieldProvider>
...
const RadioGroupItem = forwardRef((props, ref) => {
    ...
    const stringifiedChildren = typeof children === 'function'
        ? null
        : childrenToString(children);
    const { value: groupValue, onValueChange: groupOnValueChange, isInvalid: groupIsInvalid, isDisabled: groupIsDisabled, variant: groupVariant, } = useRadioGroup();
    ...
    return (<FormFieldProvider value={formFieldContextValue}>
      <RadioGroupItemProvider value={contextValue}>
        <RadioGroupPrimitives.Item ref={ref} value={value} className={itemClassName} isDisabled={isDisabledValue} {...restProps}>
          {content}
