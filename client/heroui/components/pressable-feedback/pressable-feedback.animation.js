...
import { BASE_RIPPLE_PROGRESS_DURATION, BASE_RIPPLE_PROGRESS_DURATION_MIN, } from './pressable-feedback.constants';
...
export function usePressableFeedbackRootAnimation(options) {
    ...
    const { animationConfig: rootConfig, isAnimationDisabled: isRootDisabled } = getRootAnimationState(animation);
