...
import { PressableFeedbackRootAnimationProvider, usePressableFeedbackHighlightAnimation, usePressableFeedbackRippleAnimation, usePressableFeedbackRootAnimation, usePressableFeedbackScaleAnimation, } from './pressable-feedback.animation';
import { DISPLAY_NAME } from './pressable-feedback.constants';
import { pressableFeedbackClassNames, pressableFeedbackStyleSheet, } from './pressable-feedback.styles';
const AnimatedPressable = Animated.createAnimatedComponent(Pressable);
// --------------------------------------------------
const PressableFeedback = forwardRef((props, ref) => {
    const { isDisabled = false, isAnimatedStyleActive = true, className, style, animation, children, onLayout, onPressIn, onPressOut, ...restProps } = props;
    const { isPressed, containerWidth, containerHeight, isAllAnimationsDisabled, animationOnPressIn, animationOnPressOut, rScaleStyle, } = usePressableFeedbackRootAnimation({
        animation,
    });
    ...
    return (<AnimationSettingsProvider value={animationSettingsContextValue}>
        <PressableFeedbackRootAnimationProvider value={animationContextValue}>
          <AnimatedPressable ref={ref} disabled={isDisabled} className={rootClassName} style={rootStyle} onLayout={handleLayout} onPressIn={handlePressIn} onPressOut={handlePressOut} {...restProps}>
            {children}
          </AnimatedPressable>
...
// --------------------------------------------------
const PressableFeedbackScale = forwardRef((props, ref) => {
    ...
    return (<Animated.View ref={ref} style={scaleStyle} {...restProps}>
        {children}
      </Animated.View>);
});
// --------------------------------------------------
const PressableFeedbackHighlight = forwardRef((props, ref) => {
    ...
    const highlightStyle = isAnimatedStyleActive
        ...
        : style;
    return (<Animated.View ref={ref} pointerEvents="none" className={highlightClassName} style={highlightStyle} {...restProps}/>);
});
// --------------------------------------------------
const PressableFeedbackRipple = forwardRef((props, ref) => {
    const { animation, className, classNames, style, styles, isAnimatedStyleActive = true, onTouchStart, onTouchEnd, onTouchCancel, ...restProps } = props;
    const { rContainerStyle, backgroundColor, animationOnTouchEnd, animationOnTouchStart, } = usePressableFeedbackRippleAnimation({ animation });
    ...
    return (<View ref={ref} className={containerClassName} style={[style, styles?.container]} onTouchStart={handleTouchStart} onTouchEnd={handleTouchEnd} onTouchCancel={handleTouchCancel} {...restProps}>
      <Animated.View pointerEvents="none" className={rippleClassName} style={[
            rippleStyle,
            {
