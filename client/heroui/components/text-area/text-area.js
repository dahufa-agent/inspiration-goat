...
const TextAreaRoot = forwardRef((props, ref) => {
    ...
    return (<Input ref={ref} className={textAreaClassName} multiline={multiline} textAlignVertical={textAlignVertical} {...restProps}/>);
});
// --------------------------------------------------
