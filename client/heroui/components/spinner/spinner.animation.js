...
import { cancelAnimation, Easing, useAnimatedStyle, useSharedValue, withRepeat, withSequence, withTiming, } from 'react-native-reanimated';
import { useAnimationSettings } from '../../helpers/internal/contexts';
import { useCombinedAnimationDisabledState } from '../../helpers/internal/hooks';
import { getAnimationState, getAnimationValueProperty, getIsAnimationDisabledValue, getRootAnimationState, } from '../../helpers/internal/utils';
import { DEFAULT_ROTATION_DURATION, DEFAULT_SPINNER_INDICATOR_ENTERING, DEFAULT_SPINNER_INDICATOR_EXITING, } from './spinner.constants';
// --------------------------------------------------
/**
    ...
    useEffect(() => {
        if (isLoading) {
            if (isAnimationDisabledValue) {
                ...
                rotation.set(withRepeat(withSequence(withTiming(360, rotationTimingConfig)), -1, false));
            }
        }
        else {
