...
const InputRoot = forwardRef((props, ref) => {
    const { isInvalid: localIsInvalid, isDisabled: localIsDisabled, isBottomSheetAware, variant, className, style, selectionColorClassName: selectionColorClassNameProp, placeholderColorClassName: placeholderColorClassNameProp, onFocus: onFocusProp, onBlur: onBlurProp, ...restProps } = props;
    const formField = useFormField();
    const isInvalid = localIsInvalid !== undefined
        ? localIsInvalid
        : (formField?.isInvalid ?? false);
    const isDisabled = localIsDisabled !== undefined
        ? localIsDisabled
    ...
    return (<TextInput ref={ref} className={inputClassName} style={[inputStyleSheet.borderCurve, style]} placeholderTextColorClassName={placeholderColorClassName} selectionColorClassName={selectionColorClassName} editable={!isDisabled} onFocus={onFocus} onBlur={onBlur} {...restProps}/>);
});
// --------------------------------------------------
