...
const Chip = forwardRef((props, ref) => {
    const { children, variant = 'primary', size = 'md', color = 'accent', className, style, animation, ...restProps } = props;
    ...
    return (<AnimationSettingsProvider value={animationSettingsContextValue}>
      <ChipProvider value={contextValue}>
        <Pressable ref={ref} className={rootClassName} style={[chipStyleSheet.root, style]} {...restProps}>
