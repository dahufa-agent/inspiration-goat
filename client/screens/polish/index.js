        ...
        <ScrollView style={{ flex: 1 }} contentContainerStyle={styles.container} keyboardShouldPersistTaps="handled">
          ...
          <Animated.View entering={FadeInDown.delay(100).duration(300)} style={styles.section}>
            ...
            <View style={styles.styleGrid}>
              {POLISH_STYLES.map((style, index) => (<TouchableOpacity key={style.type} style={[
                styles.styleCard,
          ...
          <Animated.View entering={FadeInDown.delay(200).duration(300)} style={styles.section}>
            ...
            <TextInput style={styles.textInput} placeholder="请输入需要润色的文案..." placeholderTextColor="#9CA3AF" multiline value={originalText} onChangeText={setOriginalText}/>
          </Animated.View>

          <TouchableOpacity style={[styles.submitBtn, loading && styles.submitBtnDisabled]} onPress={handlePolish} disabled={loading}>
            <Text style={styles.submitBtnText}>
              {loading ? "润色中..." : "开始润色"}
            </Text>
          </TouchableOpacity>

          {polishedText ? (<Animated.View entering={FadeInDown.delay(300).duration(300)} layout={Layout.springify()} style={styles.resultSection}>
