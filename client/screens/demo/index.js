...
export default function DemoPage() {
    return (<Screen statusBarStyle="auto">
      <View className="absolute top-0 left-0 w-full h-full flex flex-col items-center justify-center">
        <Image className="w-[130px] h-[109px]" source="https://lf-coze-web-cdn.coze.cn/obj/eden-cn/lm-lgvj/ljhwZthlaukjlkulzlp/coze-coding/expo/coze-loading.gif"/>
