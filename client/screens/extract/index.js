      ...
      <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : undefined} style={{ flex: 1 }}>
        <ScrollView style={{ flex: 1 }} contentContainerStyle={styles.container} keyboardShouldPersistTaps="handled">
          ...
          <Animated.View entering={FadeInDown.delay(100).duration(300)} style={styles.section}>
            ...
            <TextInput style={styles.urlInput} placeholder="请输入文章或网页链接..." placeholderTextColor="#9CA3AF" value={url} onChangeText={setUrl} autoCapitalize="none" autoCorrect={false} keyboardType="url"/>
          </Animated.View>

          <TouchableOpacity style={[styles.submitBtn, loading && styles.submitBtnDisabled]} onPress={handleExtract} disabled={loading}>
            <Text style={styles.submitBtnText}>
              {loading ? "提取中..." : "提取文案"}
            </Text>
          </TouchableOpacity>

          {extractedContent ? (<Animated.View entering={FadeInDown.delay(200).duration(300)} layout={Layout.springify()} style={styles.resultSection}>
